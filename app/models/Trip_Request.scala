...
class Trip_Request(var request_id:Client_Request, var depart_date:Date, var depart_location:String, var depart_time:Date, var arrival_location:String, var arrival_time:Date,var airline:String,var rental:Boolean, var taxi:Boolean, var shuttle:Boolean, var hotel_name:String, var hotel_membership:String, var checkout_date:Date) extends Entity

object Trip_Request
{
  def apply(request_id:Client_Request,depart_date:Date, depart_location:String,  depart_time:Date,  arrival_location:String,  arrival_time:Date, airline:String, rental:Boolean,  taxi:Boolean,  shuttle:Boolean,  hotel_name:String,  hotel_membership:String,  checkout_date:Date) =
    transactional
    {
